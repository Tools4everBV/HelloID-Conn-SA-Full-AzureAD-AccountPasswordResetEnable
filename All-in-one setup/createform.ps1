...
<# Begin: DataSource "Azure-AD-User-Reset-Password-generate-table-attributes-basic" #>
$tmpPsScript = @'
# Set TLS to accept TLS, TLS 1.1 and TLS 1.2
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls -bor [Net.SecurityProtocolType]::Tls11 -bor [Net.SecurityProtocolType]::Tls12
...
Azure-AD-User-Reset-Password-generate-table-attributes-basic
'@ 
Invoke-HelloIDDatasource -DatasourceName $dataSourceGuid_1_Name -DatasourceType "4" -DatasourceInput $tmpInput -DatasourcePsScript $tmpPsScript -DatasourceModel $tmpModel -returnObject ([Ref]$dataSourceGuid_1) 
<# End: DataSource "Azure-AD-User-Reset-Password-generate-table-attributes-basic" #>

<# Begin: DataSource "Azure-AD-User-Reset-Password-generate-table-wildcard" #>
$tmpPsScript = @'
# Set TLS to accept TLS, TLS 1.1 and TLS 1.2
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls -bor [Net.SecurityProtocolType]::Tls11 -bor [Net.SecurityProtocolType]::Tls12
...
'@ 
$tmpModel = @'
[{"key":"UserPrincipalName","type":0},{"key":"Company","type":0},{"key":"department","type":0},{"key":"Title","type":0},{"key":"displayName","type":0}]
'@ 
$tmpInput = @'
...
$delegatedFormName = @'
Azure AD Account - Reset password & Unlock
'@
...
'@; 
	...
	$tmpVariables = @'
[{"name":"blnchangenextsignin","value":"{{form.blnchangenextsignin}}","secret":false,"typeConstraint":"string"},{"name":"blnenable","value":"{{form.blnenable}}","secret":false,"typeConstraint":"string"},{"name":"blnreset","value":"{{form.blnreset}}","secret":false,"typeConstraint":"string"},{"name":"password","value":"{{form.password}}","secret":false,"typeConstraint":"string"},{"name":"userPrincipalName","value":"{{form.gridUsers.UserPrincipalName}}","secret":false,"typeConstraint":"string"}]
'@ 

	$delegatedFormTaskGuid = [PSCustomObject]@{} 
$delegatedFormTaskName = @'
Azure-AD-user-reset-enable
'@
